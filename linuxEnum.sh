...
#check and list of all files and unseen files in home directory
sudofiles=`ls -al /home/*`
if [ "$sudofiles" ]; then
  echo -e "\e[00;33m[+] List of all files and unseen files in home directory!\e[00m\n$sudofiles" 
  echo -e "\n"
fi
